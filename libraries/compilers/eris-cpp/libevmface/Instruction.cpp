...
const std::map<std::string, Instruction> dev::eth::c_instructions =
{
	...
	{ "RLPDECODE", Instruction::RLPDECODE },
	{ "RLPENCODE", Instruction::RLPENCODE },
    ...
    { "CALLSTACKSIZE", Instruction::CALLSTACKSIZE },
	...
	{ "LOGSTACK", Instruction::LOGSTACK},
	{ "LOGMEM", Instruction::LOGMEM},
...
{ //												Add, Args, Ret
	...
	{ Instruction::RLPDECODE,   { "RLPDECODE",		0, 3, 1 } },
	{ Instruction::RLPENCODE,   { "RLPENCODE",		0, 3, 1 } },
	...
	{ Instruction::CALLSTACK,	{ "CALLSTACK",	    0, 1, 1 } },
	{ Instruction::CALLSTACKSIZE,	{ "CALLSTACKSIZE",	    0, 0, 1 } },
	...
	{ Instruction::GENDOUG  ,	{ "GENDOUG",		0, 0, 1 } },
	...
	{ Instruction::LOGSTACK,    { "LOGSTACK",		0, 0, 0} },
	{ Instruction::LOGMEM,      { "LOGMEM",		    0, 0, 0} },
