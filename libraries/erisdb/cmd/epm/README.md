...
The first thing to do is set up the global eris directory tree at `~/.eris`. Do this by running
...
You can see the contents of a chain's directory at `~/.eris/blockchains/thelonious/<chainId>`.
