...
import (
	"errors"
	"fmt"
	metrics "github.com/eris-ltd/epm-go/Godeps/_workspace/src/github.com/yvasiyarov/go-metrics"
	"github.com/eris-ltd/epm-go/Godeps/_workspace/src/github.com/yvasiyarov/newrelic_platform_go"
	"log"
	"net/http"
)
